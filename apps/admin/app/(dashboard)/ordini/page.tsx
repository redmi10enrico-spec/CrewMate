  ...
  return (
    <div className="mx-auto max-w-4xl px-8 py-16">
      ...
      <p className="mt-2 text-text-muted">
        Storico degli ordini dello Shop. La ri-consegna manuale via RCON arriva in Fase 6.
      </p>

      <div className="mt-8">
        <DataTable
          columns={[
            { header: "Ordine", cell: (order) => <span className="font-mono text-xs">{order.id.slice(0, 8)}</span> },
            {
              header: "Data",
